...
const projectImages = {
  'Bemis Innovation Center': [
    './src/assets/Office Building/BemisInnovationCenter.jpg',
    './src/assets/Office Building/BemisInnovationCenter1.jpg',

  ],
  'One Menasha Center': [
    './src/assets/Office Building/OneMenashaCenter.jpg',
    './src/assets/Office Building/OneMenashaCenter1.jpg',
    './src/assets/Office Building/OneMenashaCenter2.jpg',
  ],
  'Reynoalds Crossing West': [
    './src/assets/Office Building/ReynoldsCrossingWest.jpg',
    './src/assets/Office Building/ReynoldsCrossingWest1.jpg',

  ],
  'Sherian Army Research Center': [
    './src/assets/Office Building/SheridanArmyReservecenter.jpg',
    './src/assets/Office Building/SheridanArmyReservecenter1.jpg',
  ],
  'YMCA Of Marquette County': [
    './src/assets/Office Building/YMCAOfMarquetteCounty.jpg',
    './src/assets/Office Building/YMCAOfMarquetteCounty1.jpg',
  ],
  ...
  return (
    <div className="project-detail-page">
      ...
      <section className="description-section">
        ...
        <p>
          This section provides a detailed description of the Office Building projects completed,
