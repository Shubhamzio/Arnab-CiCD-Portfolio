  ...
  return (
    ...
    <div className ='book_details'>
      <div className='image_and_header'>
        ...
        <h1>Switch by Chip & Dan Heath
 </h1>

      </div>
        {/* first part starts  */}
        <div className='first_part'>
   <h1>Chapter 1: Three Surprises About Change
</h1>
    <p> One study, people with the large buckets ate 53 percent more popcorn than people n size
...
3. What looks like resistance isis often oer a lack of clarity.
...
If you want to change things, you've got to appeal to both Th and The Elephant. The former provides the planning and direction, and the latter provides the energy.
When Rider and Elephant disagree about which way to move got a problem.
The authors on why change is hard:
When people try to change things, they're usually tinkering with behaviors that have become automatic, and changing those behaviors requires careful supervision by the Rider. The bigger the change you're suggesting, the more it will sap people's self-control. And when people exhaust their self-control
mental muscles needed to think creatively, to focus, to inhibit their impulses, and to persist in the face of frustration or failure. In other words, they're exhausting precisely the mental muscles needed to make a big change.
When people try to change things, they're usually tinkering with behaviors that have become automatic, and changing those behaviors requires careful supervision by the Rider. The bigger the change you're suggesting, the more it will sap people's self-control. And when people exhaust their self-control
mental muscles needed to think creatively, to focus, to inhibit their impulses, and to persist in the face of frustration or failure. In other words, they're exhausting precisely the mental muscles needed to make a big change.
...
3. Shape the Path. What looks like apeople problem is oftenasituation problem. The authors call the situation (including the surrounding environment) the "Path." When you shape the Path, you make change more likely, no matter what's happening with the Rider and Elephant.
...
<div className='second_part'>
  <h1>Chapter 2: Find the Bright Spots.</h1>
<p> Bright spots are successful efforts worth emulating.
...
what they're exhausting are the
...
Big problems are rarely solved with commensurately big solutions. Instead, they are most often solved by a sequence of smallsolutions, sometimes over weeks, sometimes over decades.
...
<div className ='third_part'>
  <h3>Chapter 3: Script the Critical Moves</h3>
  <p>Decisions are the Rider's turf, and because they require careful supervision and self-control, they tax the Rider's strength.
The more choices the Rider is offered, the more exhausted the Rider gets.
In one study, shoppers who saw only 6 jams on display are 10 times more likely to buy a jar ofjam.
Change brings new choices that create uncertainty.
-and found that 62 percent of them were negative versus 38 percent positive.
...
You can't script -that would be like trying to foresee the seventeenth move in achess
When you want eto beha way, explain the "new way" clearly. Don't assur
If you are leading a change effort, you need to remove the ambiguity from your vision of change.
Until you can ladder your way down from a change idea to a specific hehavior, you're not ready to lead a switch.
...
<div className ='fourth_part'>
  <h3>Chapter 4: Point to the Destination</h3>
  <p>When you describe a compelling destination, you're helping to correct one of the Rider's great weaknesses-the tendency to get lost in analysis.
...
about the failures. Instead, investigate and clone the successes. Next, give direction to the Rider-both a start and a finish. Send him a destination postcard and script his critical moves.
When you do these things, you'll prepare the Rider to lead a switch. And you'llarm him for the ongoing struggles with his reluctant and formidable partner, the Elephant.</p>

</div>
<div className ='fifth_part'>
  <h3>Chapter 5: Find the Feeling
</h3>
  <p>In one study, John Kotter and Dan Cohen observed that, in almost all successful change efforts, the sequence of change is not ANALYZE-THINK-CHANGE, but rather SEE-FEEL-CHANGE
...
To solve bigger, more ambiguous problems, we need to encourage open minds, creativity, and hope.</p>

</div>
<div className ='sixth_part'>
  <h3>Chapter 6: Shrink the Change
</h3>
  <p>One way to motivate action is to make people feel as though they're already closer to the finish line than they might have thought.
...
The value of the miracle that it focuses attention on smallsteps
When yo visible
I milestones that are attainable and visible rather than on the eventual destination, which may seem very remote.
achieve them, they start to get it into their heads that they can succeed.
Psychologist eick, i called "Small Wins: Redefining the Scale of Social Problems," said, "A small win reduces importance ('this is no big deal'), reduces demands ('that's all that needs to be done'), and raises perceived skill levels ('I can do at least that')."
