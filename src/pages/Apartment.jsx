...
const projectImages = {
  'Wheat Ridge Apartments': [
    './src/assets/Apartment/WheatRidgeApartments.jpg',
    './src/assets/Apartment/WheatRidgeApartments1.jpg',
  ],
};
...
const Apartment = () => {
  ...
  return (
    <div className="project-detail-page" data-aos='fade-right' data-aos-duation='800'>
      <section className="title-section">
        <h1>Apartment Projects</h1>
      </section>

      <section className="cards-section" data-aos='zoom-in-down' data-aos-duration='800' >
