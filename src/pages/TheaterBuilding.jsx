...
const projectImages = {
  'The New Eta Creative Arts Foundation Complex': [
    './src/assets/Theater Building/TheNewEtaCreativeArtsFoundationComplex.jpg',

  ],
  'Havre De Grace Opera House': [
    './src/assets/Theater Building/HavreDeGraceOperaHouse.jpg',
    './src/assets/Theater Building/HavreDeGraceOperaHouse1.jpg',
  ],
};
  ...
  return (
    <div className="project-detail-page">
      ...
      <section className="description-section">
        ...
        <p>
          This section provides a detailed description of the apartment projects completed,
...
export default TheaterBuilding;
